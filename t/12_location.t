...
my @test_locations = (
	...
	[  47,  1,  1,  701 ],		# #line 800another-filename

	[  48,  1,  1,  800 ],		# $e
	[  48,  3,  3,  800 ],		# \n

	[  49,  1,  1,  801 ],		# #line 900 yet-another-filename

	[  50,  1,  1,  900 ],		# $f
	[  50,  3,  3,  900 ],		# \n

	[  51,  1,  1,  901 ],		# #line 1000"quoted-filename"
	...
	[  54,  1,  1, 1002 ],		# =pod #line 1100 (not in column 1)

	[  59,  1,  1, 1007 ],		# $h
	[  59,  3,  3, 1007 ],		# \n

	[  60,  1,  1, 1008 ],		# =pod #line 1200

	[  65,  1,  1, 1202 ],		# $i
	[  65,  3,  3, 1202 ],		# \n

	[  66,  1,  1, 1203 ],		# =pod # line 1300

	[  71,  1,  1, 1302 ],		# $j
	[  71,  3,  3, 1302 ],		# \n

	#  No space between "line" and number causes it to not work.
	[  72,  1,  1, 1303 ],		# =pod #line1400

	[  77,  1,  1, 1308 ],		# $k
	[  77,  3,  3, 1308 ],		# \n

	[  78,  1,  1, 1309 ],		# =pod #line 1500 filename

	[  83,  1,  1, 1502 ],		# $l
	[  83,  3,  3, 1502 ],		# \n

	[  84,  1,  1, 1503 ],		# =pod #line 1600another-filename

	[  89,  1,  1, 1602 ],		# $m
	[  89,  3,  3, 1602 ],		# \n

	[  90,  1,  1, 1603 ],		# =pod #line 1700 yet-another-filename

	[  95,  1,  1, 1702 ],		# $n
	[  95,  3,  3, 1702 ],		# \n

	[  96,  1,  1, 1703 ],		# =pod #line 1800"quoted-filename"
